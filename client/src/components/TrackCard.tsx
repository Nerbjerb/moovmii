    ...
    <div className="relative flex items-center gap-3">
      ...
      <Card className="relative flex items-start gap-0 p-0 rounded-[18px] overflow-visible border-0 bg-[#D9D9D9] z-30 w-[570px]">
        ...
        >
          ...
          <div 
            ...
            style={{ gridRow: '1 / 7', gridColumn: '3', alignSelf: 'start', paddingTop: '18px', transform: 'translate(10px, -10px)' }}
          >
      ...
      <div className="flex gap-3 items-center z-40">
        {secondArrival !== undefined && (
          <div className="bg-[#C3C3C3] rounded-xl h-[115px] w-[77px] flex flex-col items-center justify-center gap-1 z-40">
        ...
        {thirdArrival !== undefined && (
          <div className="bg-[#ABABAB] rounded-xl h-[115px] w-[77px] flex flex-col items-center justify-center gap-1 z-40">
            <div className="w-10 h-10 rounded-full flex items-center justify-center">
              {iconSrc ? (
                <img
                  src={iconSrc}
