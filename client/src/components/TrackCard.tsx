    ...
    <div className="relative flex items-center gap-[23px]">
      ...
      <Card className="relative rounded-[9px] overflow-visible border-0 bg-[#2D2C31] z-30 w-[510px] h-[115px]">
        ...
        <div 
          ...
          style={{ right: '24px', top: '18px', transform: 'translateY(-10px)' }}
        >
      ...
      <div className="flex gap-[23px] items-center z-40">
        {secondArrival !== undefined && (
          <div className="bg-[#2D2C31] rounded-[6px] h-[115px] w-[98px] flex flex-col items-center justify-center gap-1 z-40">
