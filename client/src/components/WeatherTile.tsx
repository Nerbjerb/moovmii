      ...
      <div className="flex items-center gap-3" style={{ transform: 'translateX(-30px) translateY(-5px)' }}>
        ...
        <div className="flex flex-col items-center">
          <div style={{ transform: 'translateY(-20px)', ...(isEditMode ? { boxShadow: '0 0 0 3px #FFFFFF', borderRadius: '8px', padding: '4px 8px' } : {}) }}>
            <div className="font-bold text-center" style={{ fontSize: '48px', lineHeight: 1 }} data-testid="text-temperature">{temperature}</div>
            <div className="text-center" style={{ fontFamily: 'Helvetica, Arial, sans-serif', fontSize: '30px', color: '#ffffff', marginTop: '4px' }} data-testid="text-description">{description}</div>
          </div>
          {rainToday && (
            <div
